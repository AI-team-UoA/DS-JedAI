...
//
//// TODO adjust like others
//case class DirtyGIAnt(source:RDD[EntityT], partitionBorders: Array[Envelope], tileGranularities: TileGranularities) {
//
//
//    /**
...
//
//        val env1 = s.geometryApproximation
//        val env2 = t.geometryApproximation
//        val epsilon = 1e-8
//
...
//     */
//    def filterVerifications(s: EntityT, t: EntityT, relation: Relation, block: (Int, Int), partition: Envelope): Boolean =
...
//                val source: Array[EntityT] = p.toArray
