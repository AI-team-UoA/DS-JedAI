...
//import model.entities.{EntityT, SpatialEntityType}
...
//        val sourceRDD: RDD[(Int, EntityT)] = partitioner.distributeAndTransform(sourceSpatialRDD, entityType)
//        val approximateSourceCount = partitioner.approximateCount
//        sourceRDD.persist(StorageLevel.MEMORY_AND_DISK)
//
//        log.info(s"DS-JEDAI: Source was loaded into ${sourceRDD.getNumPartitions} partitions")
//
//        val theta = TileGranularities(sourceRDD.map(_._2.geometryApproximation), approximateSourceCount, conf.getTheta)
