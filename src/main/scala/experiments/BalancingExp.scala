...
//        val unionRDD = new SpatialRDD[Geometry]
//        unionRDD.rawSpatialRDD = sourceSpatialRDD.rawSpatialRDD.rdd.union(targetSpatialRDD.rawSpatialRDD)
//        val partitioner = GridPartitioner(unionRDD, partitions, gridType)
//
...
//            log.info("-----------------------------------------------------------\n")
//
//            val (totalContains, totalCoveredBy,
//                totalCovers, totalCrosses, totalEquals,
//                totalIntersects, totalOverlaps, totalTouches,
//                totalWithin, intersectingPairs, interlinkedGeometries) = giantResults |+| indexedJoinResults
//            val totalRelations = totalContains + totalCoveredBy + totalCovers + totalCrosses +
//                                totalEquals + totalIntersects + totalOverlaps + totalTouches + totalWithin
//
